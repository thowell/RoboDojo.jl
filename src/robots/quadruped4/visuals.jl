function build_robot!(vis::Visualizer, model::Quadruped4;
...
function set_robot!(vis::Visualizer, model::Quadruped4, q::AbstractVector;
...
function visualize!(vis, model::Quadruped4, q;
	Δt=0.1,
	r_body=0.02, r_thigh=0.0175, r_calf=0.0125, r_hip=0.02, r_knee=0.02, r_foot=0.02,
