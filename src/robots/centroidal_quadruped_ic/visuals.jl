function build_robot!(vis::Visualizer, model::CentroidalQuadrupedIC;
	body_height=0.025,
	body_length=0.1,
	body_width=0.1,
	foot_radius=0.025,
...
function set_robot!(vis::Visualizer, model::CentroidalQuadrupedIC, q::AbstractVector;
...
function visualize!(vis, model::CentroidalQuadrupedIC, q;
	Δt=0.1,
	body_height=0.025,
	body_length=0.1,
	body_width=0.1,
